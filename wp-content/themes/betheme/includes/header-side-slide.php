...
// #Side_slide
echo '<div id="Side_slide" class="'. $side_class .'" data-width="'. mfn_opts_get( 'responsive-side-slide-width', 250 ) .'">';
...
if( $woocommerce && $show_cart ){
	echo '<a class="icon cart" id="slide-cart" href="'. esc_url( wc_get_cart_url() ) .'"><i class="'. $show_cart .'"></i><span>'. $woocommerce->cart->cart_contents_count .'</span></a>';
}
