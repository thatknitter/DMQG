...
Tags: user directory, BuddyPress, S2Member, Cimy User Extra Fields, user meta fields, profile fields, member directory, website directory, directory, user listing, users, members, user profile, user profiles
...
1. Full compatibility with BuddyPress Extended Profile, S2Member Custom Fields, and Cimy User Extra Fields
...
9. Search by any user meta field with our Meta Fields Search add-on
10. Create multiple directory instances with our Multiple Directories add-on
11. Easily format the display in the following ways:
...
6. Actual Site #2
7. Actual Site #3
8. 1 of 4: plugin settings page
9. 2 of 4: plugin settings page
10. 3 of 4: plugin settings page
11. 4 of 4: plugin settings page
