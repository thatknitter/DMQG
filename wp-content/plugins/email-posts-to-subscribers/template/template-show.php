...
<div class="wrap">
  <div id="icon-plugins" class="icon32"></div>
	...
	<form name="frm_elp_display" method="post">
	  ...
	  <div class="tablenav">
		<a href="<?php echo ELP_ADMINURL; ?>?page=elp-email-template&amp;ac=add"><input class="button action" type="button" value="<?php _e('Create New Template', 'email-posts-to-subscribers'); ?>" /></a>
